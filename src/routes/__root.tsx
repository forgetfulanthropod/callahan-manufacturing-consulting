...
const APP_NAME = "Callahan Manufacturing Consulting";
  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "EV manufacturing consulting for OEM and Tier-1 programs. Battery, e-drive, body, paint, launch, and the 100 plant problems we staff.",
      },
