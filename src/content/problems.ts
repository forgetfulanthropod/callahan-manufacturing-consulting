...
export const problems: Problem[] = [
  ...
  {
    id: 33,
    title: "Aluminum / steel mix that the body shop was not tooled for",
    summary:
      "SPR, FDS, and weld that fight each other. We reset joining strategy and the robot density that follows.",
    category: "Body & paint",
    typicalOwner: "Body PE",
  },
  {
    id: 34,
    title: "Skateboard dimensional stack that kills closure flush",
    summary:
      "A floor that is “in spec” and doors that are not. Datum strategy and the one fixture that is lying.",
    category: "Body & paint",
    typicalOwner: "Dimensional",
  },
  {
    id: 35,
    title: "Robot density vs. mix-model takt after a mid-cycle change",
    summary:
      "A shop that ran one model and now runs three. We recover takt without a $40M respot.",
    category: "Body & paint",
    typicalOwner: "Body ops",
  },
  {
    id: 36,
    title: "Hemming splits on aluminum closures",
    summary:
      "Hems that crack at the corner. Tool, alloy, and a lube that paint will still accept.",
    category: "Body & paint",
    typicalOwner: "Closures PE",
  },
  {
    id: 37,
    title: "Battery tray as a structural member — and a leak path",
    summary:
      "The tray is now the floor. Crash, leak, and assembly access cannot be three different teams.",
    category: "Body & paint",
    typicalOwner: "BIW / pack",
  },
  {
    id: 38,
    title: "Sealer skip that becomes a corrosion claim at 36 months",
    summary:
      "A bead the camera likes and water does not. Path, viscosity, and a winter-test correlation.",
    category: "Body & paint",
    typicalOwner: "Sealer / paint",
  },
  {
    id: 39,
    title: "E-coat throw into closed rockers on an EV skateboard",
    summary:
      "Cavities that rust from the inside. Throwing power, drain holes, and a cut-and-see cadence.",
    category: "Body & paint",
    typicalOwner: "E-coat",
  },
  {
    id: 40,
    title: "Paint first-run capability below 70% on a light color",
    summary:
      "Dirt, orange peel, and a booth that was balanced for a darker ICE program. We find the real dirt source.",
    category: "Body & paint",
    typicalOwner: "Paint ops",
  },
  {
    id: 41,
    title: "Two-tone and contrast-roof takt that the booth cannot hold",
    summary:
      "A marketing color that doubled booth time. Masking, sequence, and an honest capacity number.",
    category: "Body & paint",
    typicalOwner: "Paint PE",
  },
  {
    id: 42,
    title: "Oven profiles that overbake adhesives on aluminum hang-on parts",
    summary:
      "Bonded parts that fail later. We map the metal temperature, not the air temperature.",
    category: "Body & paint",
    typicalOwner: "Paint / adhesives",
  },
  {
    id: 43,
    title: "Phosphate and pretreatment on mixed-metal BIW",
    summary:
      "Steel wants one bath, aluminum another. We pick the chemistry the warranty can live with.",
    category: "Body & paint",
    typicalOwner: "Pretreatment",
  },
  {
    id: 44,
    title: "Paint energy intensity after the ICE heat source went away",
    summary:
      "Ovens sized for a plant that no longer has a foundry next door. Load, recovery, and a capital case that finance will fund.",
    category: "Body & paint",
    typicalOwner: "Energy / paint",
  },
  {
    id: 45,
